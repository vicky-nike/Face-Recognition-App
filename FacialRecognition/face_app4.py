...
def keyboardShow(event):
    os.system("florence -f show")

def keyboardHide():
    os.system("florence -f hide")
...
def stay_at_bottom():
   root.lower()
   root.after(1, stay_at_bottom)

#Start florence keyboard
#kbd = sess_bus.get_object('org.florence.Keyboard', '/org/florence/Keyboard')
stay_at_bottom()
#BG labels
